...
function resizeElements()
{
	...
	heir_list_element.style.height = String( Math.min( Math.max(dynamic_height,250), window.innerHeight * 0.7 ) ) + "px";
	...
	desc_element.style.height = String( Math.min( Math.max(dynamic_height,150), window.innerHeight * 0.7 ) ) + "px";
}
